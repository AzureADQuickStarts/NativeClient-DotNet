# Call a Web API from a Native WPF App
...
To get started, [download the app skeleton](https://github.com/AzureAdSamples/Getting-Started-Tutorials/DotNet/NativeClient-DotNet/Skeleton) or [download the completed sample](https://github.com/AzureAdSamples/Getting-Started-Tutorials/DotNet/NativeClient-DotNet/Completed).  You'll also need an Azure AD tenant in which you can create users and register an application.  If you don't already have a tenant, [learn how to get one]().
...
For reference, the completed sample (without your configuration values) is provided [here](https://github.com/AzureAdSamples/NativeClient-DotNet).  You can now move on to additional scenarios.  You may want to try:

[Call a Multi-Tenant Web API from a Native Client >>](/DotNet/NativeClient-WebAPI-MultiTenant-DotNet/README.md)
